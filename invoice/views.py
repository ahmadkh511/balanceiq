...
# ============================================================================
# IMPORTATIONS DOUBLONS / NON UTILISÉES (À VÉRIFIER ET SUPPRIMER SI NÉCESSAIRE)
# ============================================================================

# 1. استيرادات مكررة من مكتبات بايثون القياسية
#    - decimal: مستخدم في السطر 7 وتم دمجه

# 2. استيرادات مكررة من Django
#    - NamedTemporaryFile: من django.core.files.temp (السطر 21) ومكرر من tempfile (السطر 10) - تم الاحتفاظ بواحد
#    - gettext و gettext_lazy: تم دمجهما في سطر واحد

# 3. استيرادات مكررة من django.db.models.functions
#    - Coalesce: مكرر في السطر 32 و 51 - تم دمجه

# 4. استيرادات مكررة من .models
#    - User: موجود في django.contrib.auth.models (السطر 16) ومكرر في .models (السطر 43) - تم الاحتفاظ بواحد
#    - WebsiteOrder, WebsiteOrderItem: مكرر في السطر 44 و 81 و 84 - تم دمجه
#    - Cart, CartItem: مكرر في السطر 44 و 86 و 93 - تم دمجه
#    - StoreBanner: مكرر في السطر 44 و 77 و 87 - تم دمجه
#    - ProductStoreSetting: مكرر في السطر 44 و 97 - تم دمجه
#    - PricingSetting: مكرر في السطر 44 و 49 - تم دمجه
#    - CashTransaction: مكرر في السطر 44 و 60 و 70 - تم دمجه

# 5. استيرادات مكررة من .forms
#    - SaleReturnForm, SaleReturnItemForm: مكرر في السطر 61 و 70 - تم دمجه

# 6. استيرادات مكررة من django.shortcuts
#    - render, get_object_or_404, redirect: مكرر في عدة أماكن - تم دمجه

# 7. استيرادات مكررة من django.http
#    - JsonResponse: مكرر في السطر 28 و 45 و 54 و 66 و 73 و 95 - تم دمجه

# 8. استيرادات مكررة من django.contrib
#    - messages: مكرر في السطر 12 و 56 و 81 - تم دمجه

# 9. استيرادات مكررة من django.db
#    - transaction: مكرر في السطر 23 و 57 و 70 و 81 - تم دمجه

# 10. استيرادات مكررة من django.db.models
#     - Sum: مكرر في السطر 26 و 59 و 70 - تم دمجه
#     - F: مكرر في السطر 26 و 59 - تم دمجه
#     - DecimalField: مكرر في السطر 26 و 59 - تم دمجه
#     - Q: مكرر في السطر 26 و 95 - تم دمجه

# 11. استيرادات غير مستخدمة (يجب مراجعتها):
#     - SimpleNamespace (السطر 8) - غير مستخدم
#     - timedelta (السطر 11) - غير مستخدم
#     - User from django.contrib.auth.models (السطر 16) - قد يكون مستخدم في مكان آخر
#     - Func (السطر 26) - غير مستخدم
#     - Value (السطر 26) - غير مستخدم
#     - CharField (السطر 26) - غير مستخدم
#     - ExpressionWrapper (السطر 26) - غير مستخدم
#     - Concat (السطر 27) - غير مستخدم
#     - Now (السطر 27) - غير مستخدم
#     - ContentFile (السطر 20) - غير مستخدم
#     - Paginator (السطر 22) - غير مستخدم
#     - send_mail (السطر 24) - غير مستخدم
#     - Count (السطر 26) - غير مستخدم
#     - Prefetch (السطر 26) - غير مستخدم
#     - csrf_exempt (السطر 31) - غير مستخدم
#     - require_GET (السطر 32) - غير مستخدم
#     - DetailView, DeleteView (السطر 33) - غير مستخدم
#     - slugify (السطر 30) - غير مستخدم
#     - reverse, reverse_lazy (السطر 29) - غير مستخدم
#     - HttpResponse (السطر 28) - غير مستخدم
#     - settings (السطر 13) - غير مستخدم

# 12. استيرادات مكررة في نهاية الملف:
#     - json: مكرر (السطر 46, 54, 66, 73, 79, 95)
#     - Decimal: مكرر (السطر 47, 58, 67, 74, 80, 90)
#     - get_object_or_404: مكرر (السطر 48, 89, 93)
#     - redirect: مكرر (السطر 48, 89, 93)
#     - transaction: مكرر (السطر 57, 70, 81)
#     - Sum: مكرر (السطر 59, 70)
#     - login_required: مكرر (السطر 55, 69, 84, 96)
#     - timezone: مكرر (السطر 60, 71)
#     - inlineformset_factory: مكرر (السطر 61, 71)

# ملاحظة: العديد من الاستيرادات في نهاية الملف هي إما مكررة أو تم تضمينها بالفعل في القسم العلوي.
# يوصى بمراجعة الملفات التي تحتوي على هذه الاستيرادات وحذف الكتل المكررة من أسفل الملفات.
